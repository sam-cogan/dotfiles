# sam-cogan does dotfiles - forked from holman's repo

### WSL Configuration / Install
Run the following to configure WSL from scratch...
```
bash -c "$(curl -fsSL https://raw.githubusercontent.com/sam-cogan/dotfiles/wsl/configure.sh)"
```
### WSL Emulator Install
Run the following command from an Administrator PowerShell prompt...
```
Set-ExecutionPolicy Bypass; irm 'https://raw.githubusercontent.com/sam-cogan/dotfiles/wsl/wslterm.ps1' | iex;
```
...
[Fork holman's](https://github.com/holman/dotfiles/fork) or [Fork mine](htps://github.com/sam-cogan/dotfiles/fork), remove what you don't
